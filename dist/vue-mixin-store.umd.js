...
var generateFieldName = function generateFieldName(func, type) {
  ...
  Object.keys(query).filter(function (_) {
    return !~['undefined', 'object', 'function'].indexOf(_typeof(query[_])) && !~['page', 'changing', 'is_up', '__refresh__', '__reload__', 'since_id'].indexOf(_);
...
// CONCATENATED MODULE: ./src/FlowLoader.vue?vue&type=template&id=2dc778e8&
...
/* harmony default export */ var FlowLoadervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    refresh: function refresh() {
      ...
      this.$nextTick(function _callee() {
        var query;
        return regenerator_default.a.async(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
